        ...
        <div className="bg-white border rounded-lg px-8 py-6 mx-auto my-8 max-w-2xl">
            ...
            <form>
                <div className="mb-4">
                    ...
                    <input className="border border-gray-400 p-2 w-full rounded-lg focus:outline-none focus:border-blue-400" required/>
                </div>

                <div className="mb-4">
                    <label className="block text-gray-700 font-medium mb-2"> Description </label>
                    <textarea className="border border-gray-400 p-2 w-full rounded-lg focus:outline-none focus:border-blue-400" rows="5" required/>
                </div>
                ...
                <div>
                    <button type="submit"
                            className="items-center justify-center bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600"> Save </button>
                </div>
