        ...
        <article className="p-6 text-base bg-white rounded-lg dark:bg-gray-900">
            <footer className="flex justify-between items-center mb-2">
                ...
                <div className="px-2 font-bold leading-tight">
                    ...
                    {!props.comment.isSending &&
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" className="w-6 h-6 cursor-pointer" onClick={() => deleteComment(dataGame, props.comment)}>
                ...
                {/*        type="submit"*/}
                {/*        onClick={() => deleteComment(dataGame, props.comment)}>*/}
